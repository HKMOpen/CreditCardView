...
import com.hkmui.ccdesign.pager.CardFragmentAdapter;
import com.hkmui.ccdesign.pager.CardFragmentAdapter.ICardEntryCompleteListener;
...
import static com.hkmui.ccdesign.CreditCardUtils.EXTRA_CARD_HOLDER_NAME;
import static com.hkmui.ccdesign.CreditCardUtils.*;
...
public class CardEditActivity extends AppCompatActivity {
    ...
    @DrawableRes
    private int mResLogo = 0;
    @ColorInt
    private int mLayoutColor = 0;
    ...
    private void checkParams(Bundle bundle) {
        ...
        mLayoutColor = bundle.getInt(EXTRA_SETTING_LAYOUT_BUTTON_COLOR);
        ...
        if (mLayoutColor > 0) {
            LinearLayout mLinearLayoutButtons = (LinearLayout) findViewById(R.id.buttonlayoutcolor);
            mLinearLayoutButtons.setBackgroundColor(mLayoutColor);
        }
    }
            ...
            public void onCardEntryEdit(int currentIndex, String entryValue) {
                switch (currentIndex) {
                    case 0:
                        ...
                        mCreditCardView.setCardNumber(mCardNumber);
                        mResLogo = mCreditCardView.getCardSelectedLogoRes();
                        break;
                    case 1:
                        mExpiry = entryValue;
    ...
    private void onDoneTapped() {
        ...
        intent.putExtra(EXTRA_LOGO_RES, mResLogo);
